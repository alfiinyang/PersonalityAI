...
from personality import Persona # Although Person imports Persona, explicit import can be useful if these functions ever directly interact with Persona objects.
